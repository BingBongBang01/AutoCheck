...
def _register_arista_defaults():
    ...
    from parsers import show_routing_neighbor, show_acl, show_ntp, show_snmp
    ...
    register("arista", "acl_status", show_acl.parse)
    register("arista", "ntp_status", show_ntp.parse)
    register("arista", "snmp_status", show_snmp.parse)
