...
def collect_all(inventory_path, lab_name, commands, connection_path="connection.yaml", max_workers=None,
    ...
    if customer_name and profile_name:
        ...
        general_dir = log_storage.get_general_log_dir(customer_name, profile_name)
        session_dir = os.path.join(general_dir, session_ts)
        config_snapshot_dir = os.path.join(general_dir, "config_snapshots")
    else:
