    ...
    <div class="card section-gap">
      <div class="card-header" style="justify-content:space-between;align-items:center;">
        <div style="display:flex;gap:12px;align-items:center;">
          ...
          <div><p class="card-title">장비 목록 (${inventoryDevices.length}대)</p><p class="card-desc">IP·포트·계정을 고치면 자동으로 연결을 확인합니다 — 성공한 행은 초록, 실패한 행은 빨강. 접속되면 장비의 hostname으로 이름을 맞춥니다.</p></div>
        </div>
