...
class LabGraderApp:
    ...
    def _build_body(self):
        ...
        # Rebranding labels with AutoCheck_ prefix and organizing into requested structure
        nav_items = [
            ("settings", "AutoCheck_Settings", self.show_settings),
            ("catalog", "AutoCheck_Command Catalog", self.show_catalog),
            ("inventory", "AutoCheck_Device Inventory", self.show_inventory),
            ("terminal", "AutoCheck_Session Terminal", self.show_terminal),
            ("history", "AutoCheck_Inspection Logs", self.show_history),
            ("report", "AutoCheck_Report Generation", self.show_report),
        ]
